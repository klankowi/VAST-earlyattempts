...
setwd(here("VAST_Runs/Strata_5thattempt"))
user_region$STRATA <- as.factor(user_region$Region_Name)
user_region$Region_Name <- NULL
strata_use$STRATA <- as.factor(strata_use$STRATA)
...
survs$STRATA <- as.factor(survs$Region)
survs$Region <- NULL
